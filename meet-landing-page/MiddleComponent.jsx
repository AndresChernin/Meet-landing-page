    ...
    return(
        <article className={`middle-part`}>
            ...
            <p className={`middle-part-p-tag`}>Send messages, share files, show your screen, and record your meetings — all in one 
                                  workspace. Control who can join with invite-only team access,
                                  data encryption, and data export.</p>

            <div className={`line-circle-container`}>
              <div className={`line`}></div>
              <div className={`circle`}><span className={`circle-text`}>02</span></div>
         </div>
        </article>
    )
}